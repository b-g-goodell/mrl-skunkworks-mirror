...
class TestSimulator(unittest.TestCase):
    ...
    #def test_run(self):
    #    sally = make_sally()  # Given default vals at top of script, the probability sally makes no new edges is very low.
    #    sally.run()
    #    self.assertTrue(len(sally.g.left_nodes) >= sally.runtime)  # we have at least this many left nodes.
