...
class Test_BipartiteGraph(unittest.TestCase):
    ...
    def test_add_delete(self):
        ...
        right_node = G.right[list(G.right.keys())[random.randrange(N)]]
        left_node = G.left[list(G.left.keys())[random.randrange(N)]]
        x = left_node.ident + "," + right_node.ident
        while(x in G.edges):
            x += ",0"
        par = {'data': 1.0, 'ident':x, 'left':left_node, 'right':right_node, 'weight': 0}
    ...
    def test_bfs_one(self):
        ...
        self.assertTrue(eid1 in G.edges)
        self.assertTrue(eid2 in G.edges)
        self.assertTrue(eid3 in G.edges)

        match = []
        match.append(G.edges[eid2])
    ...
    def test_bfs_fourshortest(self):
        ...
        self.assertTrue(results[0][2].right.ident == str(4))

        self.assertTrue(len(results[1])==3)
        self.assertTrue(results[1][0].left.ident == str(0))
        self.assertTrue(results[1][0].right.ident == str(3))
        self.assertTrue(results[1][1].left.ident == str(2))
        self.assertTrue(results[1][1].right.ident == str(3))
        self.assertTrue(results[1][2].left.ident == str(2))
        self.assertTrue(results[1][2].right.ident == str(5))

        self.assertTrue(len(results[2])==3)
        self.assertTrue(results[2][0].left.ident == str(1))
        self.assertTrue(results[2][0].right.ident == str(3))
        self.assertTrue(results[2][1].left.ident == str(2))
        self.assertTrue(results[2][1].right.ident == str(3))
        self.assertTrue(results[2][2].left.ident == str(2))
        self.assertTrue(results[2][2].right.ident == str(4))

        self.assertTrue(len(results[3])==3)
        self.assertTrue(results[3][0].left.ident == str(1))
        self.assertTrue(results[3][0].right.ident == str(3))
        self.assertTrue(results[3][1].left.ident == str(2))
        self.assertTrue(results[3][1].right.ident == str(3))
        self.assertTrue(results[3][2].left.ident == str(2))
        self.assertTrue(results[3][2].right.ident == str(5))
    ...
    def test_get_opt_matching(self, sample_size=10**3, verbose=False):
        for tomato in range(sample_size):
            ...
            for m in all_m:
                this_weight = 0.0
                for eid in m:
                    this_weight += G.edges[eid].weight
